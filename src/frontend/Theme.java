...
public final class Theme {
    ...
    public static Font fontRegular(int size) { return new Font("SansSerif", Font.PLAIN, size); }
    public static Font fontMedium(int size) { return new Font("SansSerif", Font.BOLD, size - 1); }
